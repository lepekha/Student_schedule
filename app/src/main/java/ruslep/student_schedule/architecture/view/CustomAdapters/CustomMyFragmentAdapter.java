...
public class CustomMyFragmentAdapter extends RecyclerView.Adapter<CustomMyFragmentAdapter.ViewHolder>{
    ...
    public CustomMyFragmentAdapter(List<Subject> subjects) {
